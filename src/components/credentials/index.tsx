        ...
        {!props?.user ? (
          <>
            <div class="flex flex-col items-center justify-center space-y-4">
              ...
              <div class="flex flex-row  gap-2 sm:flex-row sm:space-y-0">
                <button
                  onClick$={async () => {
                    await login.submit({
                      providerId: "github",
                  ...
                  class="flex h-10 items-center justify-center gap-2 rounded-lg bg-gray-900 px-2 py-2 text-sm font-medium text-white transition-colors hover:bg-gray-700"
                >
                ...
                <button
                  ...
                  class="flex h-10 items-center justify-center  rounded-lg bg-white px-2 text-sm font-medium text-gray-700 transition-colors hover:bg-gray-100"
                >
