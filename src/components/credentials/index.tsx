          ...
          <>
            <div class="flex min-h-[120px] w-full flex-col items-center justify-center space-y-4">
              <p class="text-center text-sm text-gray-300 md:text-base">
                Choose your preferred sign-in method to start chatting
              </p>
              <div class="flex w-full flex-col gap-2 px-4 sm:flex-row sm:justify-center sm:space-y-0">
                <button
                  onClick$={async () => {
                    await login.submit({
                      providerId: "github",
                  ...
                  class="flex h-10 w-full items-center justify-center gap-2 rounded-lg bg-gray-900 px-4 py-2 text-sm font-medium text-white transition-colors hover:bg-gray-700 sm:w-auto"
                >
                ...
                <button
                  ...
                  class="flex h-10 w-full items-center justify-center rounded-lg bg-white px-4 text-sm font-medium text-gray-700 transition-colors hover:bg-gray-100 sm:w-auto"
                >
